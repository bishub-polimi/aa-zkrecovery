...
// This will generate zkey files, vkey.json in build directory, 
// and Solidity verifier in packages/contracts/src/Verifier.sol
...
async function generateKeys(
  ...
  log("Starting to generate new ZKey...");
...
async function exec() {
  ...
  log("Copying build files to artifacts directory...");
  fs.copyFileSync(
  ...
  log("Compressing and copying zKeys...");
  ["", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k"].forEach((suffix) => {
    fs.writeFileSync(
